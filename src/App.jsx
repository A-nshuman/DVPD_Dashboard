...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-text">
      {/* HEADER */}
      <header className="bg-[#0D47A1] text-white p-4 flex items-center justify-between relative overflow-visible z-20">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[-25px] z-10">
          <img
            ...
            alt="Logo"
            className="w-24 h-24 object-contain rounded-full bg-white border-4 border-[#0D47A1]"
          />
        </div>
